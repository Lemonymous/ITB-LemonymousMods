...
return {
	CEO_Meridia = {
		...
		Success = {
			"A resounding victory. Hard to achieve in a region riddled with environmental hazards. Well done, #squad!",
			"Our land is a violent one, but you have shown it can be tamed. Well done.",
			"Looks like you can handle the pressure. And the heat.",
		}
	},
}